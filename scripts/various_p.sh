...
CUDA_VISIBLE_DEVICES=0 python entry.py -m moco   -d stl10-id --id-type strip --id-weight 0.25 &
CUDA_VISIBLE_DEVICES=3 python entry.py -m moco   -d stl10-id --id-type strip --id-weight 0.75 &
